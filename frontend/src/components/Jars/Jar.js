...
function Jar(props, jar ) {
    ...
    return (   
        <FigureJarWrap data-category={props.label} onClick={() => {let currJar = {id: props.id, name: props.text, type: props.type, opening_Time: props.opening_Time, status: props.status}; handleOpenJar(currJar);}}>
            <DivJarsInfo>
